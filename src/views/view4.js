            ...
            <div id="tab-content-quote-details">
              ...
              <div style="background:#fff;border:1px solid #e1e6eb;border-radius:6px;padding:20px 24px;margin-bottom:20px;">
                ...
                <div style="display:flex;align-items:center;gap:16px;margin-bottom:16px;flex-wrap:wrap;">
                  ...
                  <button id="bind-request-btn" style="padding:8px 20px;background:#1e3a5f;color:#fff;border:none;border-radius:4px;font-size:12px;cursor:pointer;font-weight:500;">Bind Request</button>
                    ...
                    <table style="width:100%;border-collapse:collapse;font-size:12px;">
                      ...
                      <tbody>
                        <tr style="border-bottom:1px solid #f0f3f6;">
                          ...
                          <td style="padding:12px 16px;color:#23282c;">Offered</td>
