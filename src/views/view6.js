        ...
        <main class="page-content">
          <div class="inner-canvas">
            ...
            <div style="background:#fff;border:1px solid #e1e6eb;border-radius:6px;padding:14px 24px;display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
              <div id="tab-quote-details" style="display:flex;align-items:center;gap:8px;cursor:pointer;font-size:13px;font-weight:600;color:#1e3a5f;border-bottom:2px solid #1e3a5f;padding-bottom:4px;">
                <i class="fa-regular fa-circle-check" style="color:#1e3a5f;"></i> Quote Details
              </div>
            ...
            <div id="tab-content-quote-details">
              ...
              <div style="background:#fff;border:1px solid #e1e6eb;border-radius:6px;padding:20px 24px;margin-bottom:20px;">
                <div style="font-size:18px;font-weight:600;color:#23282c;margin-bottom:12px;">Quote Details</div>
                <div style="display:flex;align-items:center;gap:16px;margin-bottom:16px;flex-wrap:wrap;">
                  ...
                  <button id="issue-binder-btn" style="padding:8px 20px;background:#1e3a5f;color:#fff;border:none;border-radius:4px;font-size:12px;cursor:pointer;font-weight:500;">Issue Binder</button>
                  <button style="padding:8px 20px;background:#1e3a5f;color:#fff;border:none;border-radius:4px;font-size:12px;cursor:pointer;font-weight:500;">Lapse</button>
                  <button style="padding:8px 20px;background:#1e3a5f;color:#fff;border:none;border-radius:4px;font-size:12px;cursor:pointer;font-weight:500;">Decline</button>
                </div>
                <div style="display:flex;align-items:center;gap:8px;font-size:13px;color:#23282c;position:relative;">
                  ...
                  <div id="premium-dropdown" style="display:none;position:absolute;top:24px;left:0;background:#fff;border:1px solid #e1e6eb;border-radius:6px;box-shadow:0 4px 16px rgba(0,0,0,0.12);padding:16px 20px;min-width:320px;z-index:10;">
                    <div style="font-size:14px;font-weight:600;color:#23282c;margin-bottom:14px;">Premium & Other Charges</div>
                    <div style="font-size:12px;font-weight:600;color:#1e3a5f;margin-bottom:8px;">General Liability</div>
                    <div style="display:flex;justify-content:space-between;font-size:12px;color:#23282c;margin-bottom:6px;padding-left:8px;">
                      <span>Base Premium</span><span>$300.00</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;font-size:12px;color:#23282c;margin-bottom:6px;padding-left:8px;">
                      <span>Surplus Lines Tax</span><span>$9.00</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;font-size:12px;color:#23282c;margin-bottom:10px;padding-left:8px;padding-bottom:10px;border-bottom:1px solid #f0f3f6;">
                      <span>Stamping Fee</span><span>$0.75</span>
                    </div>
                    <div style="font-size:12px;font-weight:600;color:#1e3a5f;margin-bottom:8px;">Commercial Automobile</div>
                    <div style="display:flex;justify-content:space-between;font-size:12px;color:#23282c;margin-bottom:6px;padding-left:8px;">
                      <span>Base Premium</span><span>$500.00</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;font-size:12px;color:#23282c;margin-bottom:6px;padding-left:8px;">
                      <span>Surplus Lines Tax</span><span>$15.00</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;font-size:12px;color:#23282c;margin-bottom:10px;padding-left:8px;padding-bottom:10px;border-bottom:1px solid #f0f3f6;">
                      <span>Stamping Fee</span><span>$1.25</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;font-size:13px;color:#1e3a5f;font-weight:700;">
                      <span>Total Policy Premium</span><span>$826.00</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div style="border:1px solid #e1e6eb;border-radius:6px;overflow:hidden;margin-bottom:20px;">
                ...
                <div id="quote-list-body" style="display:none;background:#fff;">
                    ...
                    <table style="width:100%;border-collapse:collapse;font-size:12px;">
                      <thead>
                        <tr style="border-bottom:1px solid #e1e6eb;">
                          ...
                          <th style="padding:12px 16px;text-align:left;font-weight:600;color:#5d6773;">Quote Effective Date</th>
                      ...
                      <tbody>
                        <tr style="border-bottom:1px solid #f0f3f6;">
                          ...
                          <td style="padding:12px 16px;color:#23282c;">Bind Request</td>
              ...
              <div style="background:linear-gradient(135deg,#dceaf4 0%,#c8dbe8 100%);border-radius:6px 6px 0 0;padding:14px 20px;display:flex;justify-content:space-between;align-items:center;font-size:14px;">
                <span style="color:#23282c;">Quote Number - <strong>Q00-0016909</strong></span>
                <span style="color:#23282c;">Quote Status - <strong>Bind Request</strong></span>
              </div>
              ...
              <div style="background:#fff;border:1px solid #e1e6eb;border-top:none;border-radius:0 0 6px 6px;padding:20px 24px;margin-bottom:24px;">
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px 40px;font-size:13px;">
                  ...
                  <div style="display:flex;"><span style="color:#5d6773;font-weight:600;min-width:200px;">Agent Name</span><span style="color:#23282c;">agent etes</span></div>
                  ...
                  <div style="display:flex;"><span style="color:#5d6773;font-weight:600;min-width:200px;">Quote Effective Date</span><span style="color:#23282c;">03/25/2026</span></div>
                  <div style="display:flex;"><span style="color:#5d6773;font-weight:600;min-width:200px;">Quote Expiration Date</span><span style="color:#23282c;">03/25/2027</span></div>
                  ...
                  <div style="display:flex;"><span style="color:#5d6773;font-weight:600;min-width:200px;">Quote Type</span><span style="color:#23282c;">New Business</span></div>
            ...
            <div id="tab-content-subjectivities" style="display:none;">
              <div style="border:1px solid #e1e6eb;border-radius:6px;overflow:hidden;margin-bottom:24px;">
                ...
                <div style="padding:16px;background:#fff;">
                  ...
                  <div style="font-size:13px;font-weight:600;color:#23282c;margin-bottom:8px;">Subjectivity List</div>
...
export function attach() {
  ...
  // Premium dropdown
  const premiumToggle = document.getElementById('premium-dropdown-toggle');
  const premiumDropdown = document.getElementById('premium-dropdown');
  if (premiumToggle && premiumDropdown) {
    premiumToggle.addEventListener('click', () => {
      premiumDropdown.style.display = premiumDropdown.style.display === 'none' ? 'block' : 'none';
    });
    document.addEventListener('click', (e) => {
      if (!premiumToggle.contains(e.target) && !premiumDropdown.contains(e.target)) {
